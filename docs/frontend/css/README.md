...
- [查看css属性是否触发重排或重绘：CSS-Inspiration](http://csscoco.com/inspiration)
- [你未必知道的49个CSS知识点](https://juejin.cn/post/6844903902123393032)
- [深入了解::before 和 ::after 伪元素](https://juejin.cn/post/6986629782666477599)

- [The Largest Library of Open-Source UI](https://uiverse.io/): 一个开源的UI组件库，里面的UI样式可以直接copy使用
...
- [还在用 JS 做节流吗？CSS 也可以防止按钮重复点击](https://mp.weixin.qq.com/s/HvBNFyyxHEhP3Xua_t9S-A)
...
- [2023年CSS自适应正方形必须拿下](https://juejin.cn/post/7204485623461691450)
- [别用图片了，CSS 遮罩合成实现带圆角的环形 loading 动画](https://mp.weixin.qq.com/s/0mbP4gdpC3h2gCD-Ofp55Q)
