...
- [基于NodeJS从零构建线上自动化打包工作流](https://mp.weixin.qq.com/s/6619NcJjuPQsZhmikDZ-Og)、[h5-Dooring](https://github.com/MrXujiang/h5-Dooring)
...
- [前端 DevOps（前端小兵成长营）](https://juejin.cn/column/6960547897611911205)

- [前端 DevOps（ 程序员成功）](https://juejin.cn/column/7008034440890810398)
...
- Monorepo
  ...
  - [前端cli + 通用前端项目cicd设计](https://juejin.cn/post/7401112990441275426)
...
- Gitlab
  - [教程：创建并运行你的第一个 GitLab CI/CD 管道](https://docs.gitlab.com/ee/ci/quick_start/)
  ...
  - [基于gitlab+k8s(container)实现CI/CD](https://mp.weixin.qq.com/s/KtE16EQKnjQ9vwxCGRtySQ)
...
- Web Worker
  ...
  - [2023 年的 Web Worker 项目实践](https://juejin.cn/post/7203274235425554488)
  - SharedWorker:[第一次弃用了 Web Worker ，因为它救不了我](https://mp.weixin.qq.com/s/IXHRpNVpS2GlQqpcTKt9Mw)
  - [把 Canvas 放到 WebWorker 中去绘制？想都不敢想有多爽！](https://mp.weixin.qq.com/s/bEgHoEtl0pCbaaxN-nVjzA)




- [前端性能优化到底该怎么做（上）— 开门见山](https://juejin.cn/post/7137058832592666655)、[前端性能优化到底该怎么做（下）— 直捣黄龙](https://juejin.cn/post/7139661845182300191)

- [浏览器层面优化前端性能(1):Chrom组件与进程/线程模型分析](https://mp.weixin.qq.com/s/aU9NrEHbBImFW_iIECiHBA)
...
- [推荐20个开源的前端低代码项目](https://mp.weixin.qq.com/s/wRDFBs4h1CpzQ_O8T_M6IA)
- [前端架构设计优化：构建可扩展的低代码平台](https://mp.weixin.qq.com/s/GqNyYx5FOw1reD1UCf1P2A)
- [实战，一个高扩展、可视化低代码前端，详实、完整](https://juejin.cn/post/7205361008272326716)
